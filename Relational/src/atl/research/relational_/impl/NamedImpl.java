 ...
 * </p>
 * <ul>
 *   <li>{@link atl.research.relational_.impl.NamedImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NamedImpl extends MinimalEObjectImpl.Container implements Named {
	...
	protected EClass eStaticClass() {
		return Relational_Package.Literals.NAMED;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Relational_Package.NAMED__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Relational_Package.NAMED__NAME:
				return getName();
		}
