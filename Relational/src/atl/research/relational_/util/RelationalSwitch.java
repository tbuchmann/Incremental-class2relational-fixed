/**
 */
package atl.research.relational_.util;
...
public class RelationalSwitch<T> extends Switch<T> {
	 ...
	 * @generated
	 */
	protected static Relational_Package modelPackage;
	...
	public RelationalSwitch() {
		if (modelPackage == null) {
			modelPackage = Relational_Package.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Relational_Package.COLUMN: {
